    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author_url_slug', models.TextField(default=uuid.uuid4, max_length=70, unique=True)),
                ('access_level', models.IntegerField(choices=[(1, 'Author'), (2, 'Reader')], default=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_social_media', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='website.author')),
            ],
            options={
